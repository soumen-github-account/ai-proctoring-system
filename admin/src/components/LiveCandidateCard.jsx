...
const LiveCandidateCard = ({ candidate, videoRef, violations }) => {
  ...
  console.log("Violations for", candidate.id, violations);
  ...
  return (
    <div className="relative bg-white rounded-xl shadow overflow-hidden">
      ...
      <video
        ref={videoRef}
        className="w-full h-48 object-cover bg-black z-0"
        autoPlay
        muted
        playsInline
      />
      ...
      {/* FOOTER */}
      <div className="p-2 text-sm font-medium border-t bg-white z-10">
